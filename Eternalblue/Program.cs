...
namespace Eternalblue
{
    class Program
    {
        ...
        static public byte[] SMB1_Get_Response(Socket sock)
        {
            ...
            response = tcp_response.Skip(4).ToArray();
            return tcp_response;
        }
        ...
        static public byte[] Check_Vulnerability(Socket sock)
        {
        ...
        static public void Detect_Version(byte[] res) {
            ...
            string lol = System.Text.Encoding.Default.GetString(res);
